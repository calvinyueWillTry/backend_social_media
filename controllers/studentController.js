...
const headCount = async () => {
  const numberOfStudents = await Student.aggregate()//building an aggregation pipeline
...
const grade = async (studentId) =>
  Student.aggregate([//start building an aggregation pipeline
...
//find their course that the student is being removed from, and update the following "columns":
  ...
  async addAssignment(req, res) {
    ...
    try {
      const student = await Student.findOneAndUpdate(//require the following add in the json array to add an assignment
